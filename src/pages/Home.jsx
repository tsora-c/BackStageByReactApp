...
class Home extends Component{
                        ...
                        <div className="card-body">
                            <div className="progress-card">
                                ...
                                <div className="progress mb-2" style={{"height":"7px"}}>
                                    <div className="progress-bar bg-success" role="progressbar" style={{width: "78%"}} aria-valuenow="78" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip" data-placement="top" title="" data-original-title="78%"></div>
                                </div>
                            </div>
                            <div className="progress-card">
                                <div className="d-flex justify-content-between mb-1">
                            ...
                            <div className="progress-card">
                                ...
                                <div className="progress mb-2" style={{"height": "7px"}}>
                                    <div className="progress-bar bg-primary" role="progressbar" style={{"width": "70%"}} aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip" data-placement="top" title="" data-original-title="70%"></div>
                                </div>
                            </div>
                            <div className="progress-card">
                                <div className="d-flex justify-content-between mb-1">
                                ...
                                <div className="progress mb-2" style={{"height": "7px"}}>
                                    <div className="progress-bar bg-warning" role="progressbar" style={{"width": "60%"}} aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" data-toggle="tooltip" data-placement="top" title="" data-original-title="60%"></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="row">
                <div className="col-md-4">
                    <div className="card">
                        ...
                        <div className="card-body">
                            <div id="monthlyChart" className="chart chart-pie"><div className="chartist-tooltip"></div></div>
                        </div>
                    </div>
                </div>
                <div className="col-md-8">
                    <div className="card">
                        ...
                        <div className="card-body">
                            <div id="salesChart" className="chart"><div className="chartist-tooltip"></div>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td className="td-actions text-right">
                                                <div className="form-button-action">
                                                    <button type="button" data-toggle="tooltip" title="" className="btn btn-link <btn-simple-primary" data-original-title="Edit Task">
                                                        <i className="la la-edit"></i>
                                                    </button>
                                                    <button type="button" data-toggle="tooltip" title="" className="btn btn-link btn-simple-danger" data-original-title="Remove">
    ...
    componentDidMount(){
        $("[tag-role='Sidebar-Nav-Ul']>li").eq(0).addClass("active")
    }
